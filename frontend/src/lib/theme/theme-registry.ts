...
const DEFAULT_LIGHT: ThemeTokens = {
  ...
  'chart-4': 'oklch(0.663 0.189 84.429)',
  'chart-5': 'oklch(0.669 0.188 70.08)',
  'chart-6': 'oklch(0.616 0.222 221.116)',
  'chart-7': 'oklch(0.6 0.118 4.704)',
  'chart-8': 'oklch(0.398 0.07 47.392)',
...
const DEFAULT_DARK: ThemeTokens = {
  ...
  'chart-1': 'oklch(0.528 0.243 264.376)',
  'chart-2': 'oklch(0.696 0.17 162.48)',
  'chart-3': 'oklch(0.769 0.188 70.08)',
  'chart-4': 'oklch(0.627 0.265 303.9)',
  'chart-5': 'oklch(0.645 0.246 16.439)',
  'chart-6': 'oklch(0.518 0.243 84.376)',
  'chart-7': 'oklch(0.696 0.17 342.48)',
  'chart-8': 'oklch(0.769 0.188 250.08)',
...
const BLUEPRINT_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.5 0.15 65)',
  'chart-7': 'oklch(0.55 0.12 20)',
  'chart-8': 'oklch(0.52 0.15 340)',
...
const BLUEPRINT_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.7 0.13 50)',
  'chart-7': 'oklch(0.7 0.12 10)',
  'chart-8': 'oklch(0.78 0.16 330)',
...
const BENTO_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.52 0.2 86)',
  'chart-7': 'oklch(0.55 0.18 120)',
  'chart-8': 'oklch(0.52 0.15 330)',
...
const BENTO_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.7 0.15 86)',
  'chart-7': 'oklch(0.75 0.13 120)',
  'chart-8': 'oklch(0.78 0.16 330)',
...
const VAPORWAVE_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.55 0.25 170)',
  'chart-7': 'oklch(0.55 0.15 40)',
  'chart-8': 'oklch(0.6 0.15 270)',
...
const VAPORWAVE_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.68 0.24 170)',
  'chart-7': 'oklch(0.78 0.16 20)',
  'chart-8': 'oklch(0.85 0.15 270)',
...
const CYBERPUNK_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.5 0.13 25)',
  'chart-7': 'oklch(0.55 0.22 170)',
  'chart-8': 'oklch(0.6 0.15 260)',
...
const CYBERPUNK_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.8 0.16 25)',
  'chart-7': 'oklch(0.65 0.24 170)',
  'chart-8': 'oklch(0.82 0.16 260)',
...
const AURORA_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.52 0.18 85)',
  'chart-7': 'oklch(0.52 0.18 120)',
  'chart-8': 'oklch(0.55 0.13 0)',
...
const AURORA_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.7 0.15 85)',
  'chart-7': 'oklch(0.72 0.16 120)',
  'chart-8': 'oklch(0.78 0.13 0)',
...
const SOLARPUNK_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.52 0.12 315)',
  'chart-7': 'oklch(0.55 0.11 250)',
  'chart-8': 'oklch(0.5 0.1 350)',
...
const SOLARPUNK_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.7 0.14 315)',
  'chart-7': 'oklch(0.72 0.13 250)',
  'chart-8': 'oklch(0.7 0.11 350)',
...
const EDITORIAL_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.5 0.17 207)',
  'chart-7': 'oklch(0.5 0.08 240)',
  'chart-8': 'oklch(0.5 0.1 320)',
...
const EDITORIAL_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.68 0.18 207)',
  'chart-7': 'oklch(0.72 0.08 240)',
  'chart-8': 'oklch(0.7 0.12 320)',
...
const TUI_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.52 0.1 265)',
  'chart-7': 'oklch(0.5 0.12 345)',
  'chart-8': 'oklch(0.5 0.13 60)',
...
const TUI_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.8 0.12 265)',
  'chart-7': 'oklch(0.72 0.13 345)',
  'chart-8': 'oklch(0.68 0.13 60)',
...
const Y2K_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.55 0.23 170)',
  'chart-7': 'oklch(0.55 0.16 25)',
  'chart-8': 'oklch(0.55 0.16 315)',
...
const Y2K_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.72 0.2 170)',
  'chart-7': 'oklch(0.8 0.15 20)',
  'chart-8': 'oklch(0.8 0.18 315)',
...
const NEOBRUTALIST_LIGHT: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.5 0.22 84)',
  'chart-7': 'oklch(0.55 0.2 205)',
  'chart-8': 'oklch(0.55 0.16 325)',
...
const NEOBRUTALIST_DARK: ThemeTokens = {
  ...
  'chart-6': 'oklch(0.7 0.18 84)',
  'chart-7': 'oklch(0.7 0.2 205)',
  'chart-8': 'oklch(0.78 0.16 325)',
