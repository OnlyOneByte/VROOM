	...
	<div class="space-y-6">
		...
		<div class="flex items-center gap-4">
			...
			<div>
				...
				{:else if !isEditMode}
					<p class="text-muted-foreground mt-1">Add a new insurance policy with an initial term</p>
				{/if}
			</div>
		</div>
							...
							<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
								...
								<div class="space-y-2">
									...
									{#if errors.deductibleAmount}
										<FormFieldError id="deductible-error">{errors.deductibleAmount}</FormFieldError>
									{/if}
								</div>
							</div>
							...
							<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
								<div class="space-y-2">
									...
									{#if errors.coverageLimit}
										<FormFieldError id="coverage-limit-error">{errors.coverageLimit}</FormFieldError
										>
									{/if}
								</div>
								<div class="space-y-2">
