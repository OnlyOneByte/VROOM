...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
	<div class="max-w-md w-full space-y-8">
		<div class="text-center">
			...
			<h2 class="text-3xl font-bold text-gray-900 mb-2">Welcome to VROOM</h2>
			<p class="text-gray-600">Track your vehicle expenses and analyze costs</p>
		</div>
		...
		<div class="card">
			<div class="space-y-6">
				...
				<div class="text-xs text-gray-500 text-center">
					By signing in, you agree to our privacy practices. We only store your email and display
					name.
				</div>
			</div>
		</div>
