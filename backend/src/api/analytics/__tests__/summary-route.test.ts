...
const MOCK_SUMMARY: AnalyticsSummaryData = {
  ...
  fuelStats: {
    ...
    gallons: { currentYear: 300, previousYear: 250, currentMonth: 25, previousMonth: 30 },
    fuelConsumption: { avgMpg: 28.5, bestMpg: 35.2, worstMpg: 22.1 },
    ...
    distance: { totalMiles: 8500, avgPerDay: 23.3, avgPerMonth: 708.3 },
    monthlyConsumption: [],
    gasPriceHistory: [],
    fillupCostByVehicle: [],
    odometerProgression: [],
