...
- [ ] 1. Setup Layerchart and dependencies
...
- [ ] 2. Replace primary stats cards with shadcn Card components
  - [ ] 2.1 Update Total Expenses card
  ...
  - [ ] 2.2 Update Last 30 Days card
    - Replace with shadcn Card component
    - Match styling from Total Expenses card
    - _Requirements: 1.2, 2.1_
  
  - [ ] 2.3 Update Monthly Average card
    - Replace with shadcn Card component
    - Ensure consistent spacing and typography
    - _Requirements: 1.2, 2.1_
  
  - [ ] 2.4 Update Avg MPG/Last Expense card
    - Replace with shadcn Card component
    - Handle conditional display logic
    - _Requirements: 1.2, 2.1_

- [ ] 3. Replace period selector with shadcn Select
...
- [ ] 5. Create ExpenseTrendChart component
  ...
  - [ ] 5.4 Wrap in shadcn Card
    - Add Card with CardHeader (title, description)
    - Place chart in CardContent
    - _Requirements: 8.1_

- [ ] 6. Create data preparation function for expense trends
...
- [ ] 7. Integrate ExpenseTrendChart into overview tab
...
- [ ] 8. Create FuelEfficiencyTrendChart component
...
- [ ] 10. Integrate FuelEfficiencyTrendChart into overview tab
...
- [ ] 11. Create CategoryPieChart component
  - [ ] 11.1 Create component file
  ...
  - [ ] 11.3 Add legend/summary section
  ...
  - [ ] 11.4 Wrap in shadcn Card
    - Add Card with CardHeader
    - Use flex layout for chart and legend
    - Make responsive (stack on mobile)
    - _Requirements: 8.2, 9.2_

- [ ] 12. Create data preparation function for category chart
...
- [ ] 13. Update Expenses by Category section
  - [ ] 13.1 Add CategoryPieChart above grid
    - Integrate pie chart component
    - Pass prepared category data
    - _Requirements: 3.1, 8.2_
  
  - [ ] 13.2 Update category grid cards
...
- [ ] 14. Update Vehicle Information section
...
- [ ] 16. Improve empty states
  ...
  - [ ] 16.2 Update no financing empty state
    - Use shadcn Card with centered content
    - Add CreditCard icon
    - _Requirements: 6.3_
  
  - [ ] 16.3 Add chart empty states
